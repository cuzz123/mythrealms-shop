...
export const STORY_CONTENT = {
  seo: {
    title: `Our Story | ${SITE_NAME} Pearl Jewelry`,
    description:
      `Discover the ${SITE_NAME} pearl point of view, how the online edit is built, and how product reference photography differs from editorial styling.`,
  },
  hero: {
    eyebrow: "Our Story",
    title: "Pearls, edited for real life.",
    description:
      `${SITE_NAME} is a focused online pearl edit, bringing pearls into everyday wardrobes, natural light, and the moments between ordinary and dressed up.`,
    image: {
