...
export const HOMEPAGE_HERO_SLIDES = [
  { src: "/images/brand/home/hero-earrings-model-v2.png", alt: "Model wearing pearl drop earrings in Mediterranean sunlight", eyebrow: "Editorial / Summer 2026", title: "Pearls for sunlit days.", description: "Pearl jewelry selected for natural light, everyday movement, and the moments worth keeping." },
  { src: "/images/brand/home/hero-necklace-model-v2.png", alt: "Model wearing a pearl and gold lariat necklace in a sunlit courtyard", eyebrow: "The Pearl Edit", title: "A quiet line of light.", description: "Pieces that settle easily into the days you already love to wear." },
  { src: "/images/brand/home/hero-bracelet-model-v2.png", alt: "Model wearing a pearl and gold bracelet on a coastal terrace", eyebrow: "Everyday Rituals", title: "Details that move with you.", description: "Warm gold, soft pearl, and an easy sense of occasion in the everyday." },
