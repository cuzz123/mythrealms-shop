      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-[var(--surface)] border border-[var(--border-light)] rounded-xl p-8 space-y-6">
          ...
          <button
            ...
            className="w-full py-3 border border-[var(--border)] rounded-full font-medium text-sm hover:bg-[var(--bg)] transition flex items-center justify-center gap-2 disabled:opacity-50"
          >
            {googleLoading ? (
