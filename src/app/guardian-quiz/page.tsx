...
export const metadata: Metadata = {
  title: "Find Your Guardian Archetype | Maverenne Quiz",
  description: "Take the 3-question Maverenne quiz to discover a guardian archetype and a path into The Pearl Edit.",
