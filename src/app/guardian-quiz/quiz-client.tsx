...
const results: Record<string, { beast: string; slug: string; subtitle: string; description: string; image: string }> = {
  "nine-tailed-fox": {
    ...
    image: imageUrl("/images/hero/nine-tailed-fox.webp"),
  },
  "azure-dragon": {
    ...
    image: imageUrl("/images/hero/azure-dragon.webp"),
  },
  phoenix: {
    beast: "Phoenix · 凤凰",
    ...
    image: imageUrl("/images/hero/phoenix.webp"),
  },
  "white-tiger": {
    ...
    image: imageUrl("/images/hero/white-tiger.webp"),
  },
  "black-tortoise": {
    ...
    image: imageUrl("/images/hero/black-tortoise.webp"),
  },
  "kun-peng": {
    beast: "Kun Peng · 鲲鹏",
    ...
    image: imageUrl("/images/hero/kun-peng.webp"),
  },
  qilin: {
    beast: "Qilin · 麒麟",
    ...
    image: imageUrl("/images/hero/qilin.webp"),
  },
  "bai-ze": {
    beast: "Bai Ze · 白泽",
    ...
    image: imageUrl("/images/hero/bai-ze.webp"),
  },
  yinglong: {
    beast: "Yinglong · 应龙",
    ...
    image: imageUrl("/images/hero/yinglong.webp"),
  },
  taotie: {
    beast: "Taotie · 饕餮",
    ...
    image: imageUrl("/images/hero/taotie.webp"),
  },
};
