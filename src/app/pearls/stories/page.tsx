...
const title = `Pearl Stories | ${SITE_NAME}`;
const description = `A focused reading list of current ${SITE_NAME} stories about styling, care, gifting, and choosing pearl jewelry.`;
      ...
      <section className="mx-auto max-w-7xl px-6 py-14 sm:py-16" aria-labelledby="current-stories-title">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <h2 id="current-stories-title" className="mt-3 font-serif text-3xl font-medium text-[var(--text)]">From the {SITE_NAME} journal</h2>
          </div>
