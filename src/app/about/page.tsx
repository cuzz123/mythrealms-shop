      ...
      <section id={section.id} className="bg-[var(--surface)]">
        <div className="mx-auto max-w-7xl px-6 py-16 sm:py-20">
          ...
          <div className="mt-10 grid gap-10 md:grid-cols-2 md:gap-6 lg:mt-14 lg:gap-10">
            {[
              { item: section.reference, role: "product-reference" },
              { item: section.editorial, role: "editorial-styling" },
            ].map(({ item, role }) => (
              <figure key={item.title} data-image-role={role} className="min-w-0">
                  ...
                  <Image
                    ...
                    className={
                      role === "product-reference"
                        ? "origin-top scale-[1.2] object-cover"
                        : "object-cover"
                    }
                    style={{
                      objectPosition:
