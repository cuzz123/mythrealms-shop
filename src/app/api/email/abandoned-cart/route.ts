...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const emailConfigs: Record<string, { subject: string; body: string }> = {
      "1h": {
        subject: "Your Intention is Waiting...",
      ...
      "24h": {
        ...
        body: `The intention pieces in your cart are calling. As a thank you for considering us, enjoy 15% off with code MYTH15. <a href="${baseUrl}/cart">Complete your order</a> — this offer expires in 48 hours.`,
      },
      "72h": {
        subject: "Last Chance — Your Intention Piece",
        body: `This is our final note. Limited edition pieces are not reproduced once sold out. If the stone you chose is meant for you, now is the time. <a href="${baseUrl}/cart">Return to your cart</a>`,
      },
    };
