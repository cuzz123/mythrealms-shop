...
const pairings = [
  ...
  { beast: "Kun Peng", slug: "kun-peng-transformation-set", label: "For the one in a season of change", line: "From the depths to the sky. Your time is now.", img: "/images/products/kun-peng.png" },
];
