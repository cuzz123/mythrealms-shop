...
稳定帧 ID：`FF_WHITE_SHELL_TRIPLE_DROPS_01_ARCH_HAIR_TUCK`
...
稳定帧 ID：`FF_WHITE_SHELL_TRIPLE_DROPS_02_SEA_STAIR_LOOKBACK`

## 产品锁定

- Exactly one pair of gold fish-hook earrings.
- Each earring has three vertically connected irregular white shell drops.
- Fine gold claw settings secure the shell drops.
- 保持每只耳环三颗贝壳、鱼钩耳线与金色爪镶不变，不增加其他首饰。
