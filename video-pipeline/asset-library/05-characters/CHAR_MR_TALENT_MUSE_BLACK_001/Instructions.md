# CHAR_MR_TALENT_MUSE_BLACK_001

黑色天鹅绒礼服与 The Light Keeper 项链

## 用途

- 同一身份模特组：`CHAR_MR_TALENT_MUSE_001`
- 服装：黑色天鹅绒
- 展示产品：`pearl-series-19` / The Light Keeper（项链）
...
这是一套图片参考，不是已经绑定骨骼的 3D 角色。画面中的珠宝必须在正式投放前与 `pearl-series-19` 的在售商品图人工核对。
