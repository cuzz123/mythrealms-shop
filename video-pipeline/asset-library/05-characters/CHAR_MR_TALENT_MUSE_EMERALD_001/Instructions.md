# CHAR_MR_TALENT_MUSE_EMERALD_001

祖母绿单肩缎面礼服与 The Listening Stone 耳环

## 用途

- 同一身份模特组：`CHAR_MR_TALENT_MUSE_001`
- 服装：祖母绿
- 展示产品：`pearl-series-16` / The Listening Stone（耳环）
...
这是一套图片参考，不是已经绑定骨骼的 3D 角色。画面中的珠宝必须在正式投放前与 `pearl-series-16` 的在售商品图人工核对。
