# Seedance 提示词｜Pearl Series 04 自然窗边版

所有片段为 9:16 竖版、每段 **4 秒**。每条均以资产包中的绝对路径上传为多图参考；路径后注明唯一职责。先生成 S01，只有接受其结果后才将它作为同场景连续段的参考视频。
...
> 保持参考图中的真实窗边公寓、奶油矿物墙、象牙亚麻帘、燕麦色椅子、浅胡桃木桌和午前自然窗光不变。4 秒内，24mm 宽景从室内极慢前推；只有亚麻帘被微风轻轻带起一次，阳光在木地板上稳定。无人、无首饰、无蓝色饰物、无文字。声音：低室内环境声、很轻的布料摩擦、远处城市底噪。结束时窗与椅子的空间关系保持清晰。

## S02｜阅读（4s）

**模式：R2V，意图剪切，不追求与 S01 帧级延续。**
...
> 同一位短深色自然卷发、象牙白亚麻连衣裙的成年女性坐在同一把椅子里读书，不直视镜头。4 秒，50mm 中景，镜头保持稳定，只在末秒向前呼吸式微推；她翻过一页书后手安静落下。自然窗光从侧面照亮真实皮肤与亚麻纹理。无耳环、项链、手链和其他首饰；无文字。声音：纸页轻响与房间底噪。停在翻页后的静止状态。
...
> 4 秒内，同一模特合上书，从窗边亚麻椅自然起身，在椅旁站稳；这是唯一动作。35mm 侧向中景，镜头不摇不晃，只跟随重心轻微上移。窗光方向、亚麻服装和房间布局保持不变。无首饰、无文字。声音：椅垫轻响、亚麻摩擦、房间底噪。结束时她身体朝窗的方向稳定。
...
> 同一模特从椅子沿清晰通道向窗走两步，停下后右手轻触亚麻帘；不要回头看镜头。4 秒，35mm 侧向缓慢跟拍，始终保持她从椅子到窗的屏幕方向。窗光稳定、帘布只因手的轻触微动。无首饰、无文字。声音：两步轻脚步声、亚麻帘摩擦、远处城市底噪。结束时手停在帘上。
...
> 4 秒，50mm 桌边中近景。亚麻封面书与空的米白陶瓷小碟放在浅胡桃木边几上；一只真实自然的手从画面外进入，停在碟边但不触碰任何首饰。镜头做极慢横向滑动，保持碟内完全空白。窗光从一侧稳定照入。无人物脸、无产品、无蓝色饰物、无文字。声音：指腹轻碰木桌的一声，随后安静房间底噪。最后一帧碟仍为空。
...
> 参考产品图只控制首饰结构：严格保留钴蓝主石与深蓝小珠、浅粉珍珠簇、古金色镂空珠和链条比例；不得重设计。4 秒，50mm 低速侧滑，米白陶瓷碟中已经安静放着完整首饰，背景只有一只手停在焦外，不拿起也不遮挡。自然窗光在古金珠上形成柔和稳定高光，产品首次完整出现。无脸、无文字、无 Logo、无多余首饰。声音：轻微陶瓷触感与安静房间底噪。结束时钴蓝主石在画面中央清晰可读。
...
> 参考产品图严格锁定首饰几何与颜色。4 秒，锁定 100mm 微距，首饰静置在米白陶瓷碟中；焦点从一颗钴蓝石缓慢移到浅粉珍珠簇与古金镂空珠。镜头不移动，只有一次稳定、真实的自然窗光反射滑过金属表面。没有手、没有脸、没有文字、没有 Logo，不改变链节或宝石数量。声音：安静房间底噪，末秒一声极轻陶瓷细响。结束时古金与粉珍珠均清晰。
...
> 参考产品图严格保留钴蓝、粉珍珠和古金结构。4 秒，85mm 稳定微推，首饰在米白陶瓷碟上呈三分之四角度，位于竖画面偏左下；右上保留干净的奶油墙留白供后期添加 MythRealms Logo。自然窗光稳定，金属高光克制，首饰不旋转、不变形。无人物、无手、无生成文字、无生成 Logo、无水印。声音：房间底噪逐渐变轻。结束为稳定、干净、可叠字的产品 Hero 底板。

## 生成后的连续性流程

1. 接受 S01 后，可把 S01 成片或尾帧作为同场景续接参考；不要将“计划状态”当作实际状态。
2. 每条成片验收后记录真实的末帧、人物位置、窗光、动作方向和声音状态，再决定是否继续或用原始锚点重新开镜。
3. S06–S08 若产品出现结构漂移，保留成功的人物 / 空间片段，在后期单独替换或合成产品层，不要重抽整段表演。
